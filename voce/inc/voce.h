...
initialization.  Request will be ignored.");
		...
		jstring jstr = internal::gEnv->NewStringUTF(message.c_str()); // CR1 internal::gEnv may be NULL
...
initialization.  Request will be ignored.");
		...
		// Call the Java method.
		internal::gEnv->CallStaticVoidMethod(internal::gClass, 
			internal::gStopSynthesizingID); // CR1 internal::gEnv may be NULL
	}
...
initialization.  Request will be ignored.");
		...
		return internal::gEnv->CallStaticIntMethod(internal::gClass, 
			internal::gGetRecognizerQueueSizeID); // CR1 internal::gEnv may be NULL
	}
...
// #CR1
		...
		jstring jstr = (jstring)internal::gEnv->CallStaticObjectMethod(
			internal::gClass, internal::gPopRecognizedStringID); // CR1 internal::gEnv may be NULL
...
initialization.  Request will be ignored.");
		...
		// Call the Java method.
		internal::gEnv->CallStaticVoidMethod(internal::gClass, 
			internal::gSetRecognizerEnabledID, e); // CR1 internal::gEnv may be NULL
	}
...
initialization.  Request will be ignored.");
		...
		jboolean b = internal::gEnv->CallStaticBooleanMethod(internal::gClass, 
			internal::gIsRecognizerEnabledID); // CR1 internal::gEnv may be NULL
